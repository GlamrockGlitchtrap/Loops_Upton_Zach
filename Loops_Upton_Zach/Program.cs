...
namespace Loops_Upton_Zach
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Why do you wnat to make games?");
            ...
            Console.WriteLine("The sum of the individual digits of {respnse2} is {SumOfDigits(response2)}!");
        }
